...
function opsSolicitudContent() {
  ...
  return `
    ...
    <section class="ops-review-card"><h2>DATOS DE CLIENTE</h2>
      ...
      ${hasDeclaredIncome ? `<details class="ops-executive-accordion"><summary><strong>INGRESOS</strong><span class="ops-summary-actions"><em>Completo</em><b>Ver detalle</b></span></summary><div class="ops-accordion-body"><section><div class="ops-review-grid">${opsReviewField('Ingreso estimado','S/ 5,850.00')}${opsReviewField('Ingreso declarado (Soles)',declaredIncome)}${opsReviewField('Tipo de categoría','1ra categoría')}${opsReviewField('Perfil','Formal')}${opsReviewField('Situación laboral','Dependiente')}${opsReviewField('Fecha de ingreso laboral','01/01/2020')}${opsReviewField('RUC del empleador','20705695330')}${opsReviewField('Ingreso neto mensual',declaredIncome)}${opsReviewField('¿Ingreso anualizado?','No')}</div></section></div></details>` : `<div class="ops-income-disabled"><strong>INGRESOS</strong><span>No se declaró ingresos</span></div>`}
